            ...
            <div className="max-w-6xl mx-auto">
                <div className="bg-cream/75 backdrop-blur-md rounded-3xl p-8 md:p-12 lg:p-16 shadow-2xl shadow-ink/5 border border-ink/5">
                    ...
                    <h2 className="font-display text-[clamp(30px,5vw,72px)] leading-[1.1] tracking-[-0.03em] text-ink mb-10 max-w-4xl">
                        <SplitText
                            text="Right now I'm shipping with"
                            stagger={0.04}
                            as="span"
                        />{" "}
                        ...
                        <div className="flex flex-wrap gap-x-8 gap-y-3 items-baseline">
                            {daily.map((item, i) => (
                                ...
                                >
                                    {item}
                                    {i < daily.length - 1 && (
                                        <span className="text-accent/60 ml-8">
                                            /
                                        </span>
                                    )}
                                </motion.span>
                        ...
                        >
                            <div>
                                ...
                                <p className="font-sans text-[14px] leading-[1.7] text-ink/70">
                                    When the problem changes, the stack changes.
                                    I was building with MCP before most
                                    engineers had heard of it. Go and Django
                                    came together in a week because the problem
                                    called for both. Any language is a week
                                    away.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="font-sans text-[14px] leading-[1.7] text-ink/70">
                                    Deployed, broken at 3am, fixed, watched real
                                    users run. I know which of these are worth
                                    betting a company on and which are just
                                    hype.
                                </p>
                            </div>
                        </motion.div>
